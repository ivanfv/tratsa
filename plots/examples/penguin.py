...
files=[["Penguin Behavior(7,13)", "../../results/transcamp/result_penguin_sample_TutorialMPweb_w800_s1_d0_t256_cov7-13_corr7-13_stat7-13_prof7-13_12088.csv"],
       ["Penguin Behavior(7,10)", "../../results/transcamp/result_penguin_sample_TutorialMPweb_w800_s1_d0_t256_cov7-10_corr7-10_stat7-10_prof7-10_11647.csv"],
       ["Penguin Behavior(5,13)", "../../results/transcamp/result_penguin_sample_TutorialMPweb_w800_s1_d0_t256_cov5-13_corr5-13_stat5-13_prof5-13_5097.csv"],
       ["Penguin Behavior(5,7)",  "../../results/transcamp/result_penguin_sample_TutorialMPweb_w800_s1_d0_t256_cov5-7_corr5-7_stat5-7_prof5-7_4174.csv"]]
...
for i in range(len(files)):
  ...
  ax.legend(fontsize=10,ncol=1, columnspacing=1, loc='upper right')

	  


plt.savefig("./penguin_MP_profiles.pdf", format='pdf')
