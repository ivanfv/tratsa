...
################################################################################
class StatsFile():
  MotifsAccuRe = re.compile("#Top-1000 accuracy w\.r\.t double: Motifs float,float±100,transp,transp±100")
  DiscordsAccuRe = re.compile("#Top-1000 accuracy w\.r\.t double: Discords float,float±100,tranps,transp±100")
...
if __name__ == "__main__":
   a=StatsFile("../../../transcampfpga/results/imu/accuracy_imu_w256_e7_m13_t65536.txt", True)
   tmp = a.GetMotifsAccu()
