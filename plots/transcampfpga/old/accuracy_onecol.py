...
files=[["Speech","../../../transcampfpga/results/audio/accuracy_audio_w16384_e%d_m%d_t65536.txt"],
       ["ECG", "../../../transcampfpga/results/e0103/accuracy_e0103_w512_e%d_m%d_t262144.txt"],
       ["Power", "../../../transcampfpga/results/power/accuracy_power_w1536_e%d_m%d_t262144.txt" ],
       ["Seismology", "../../../transcampfpga/results/seismology/accuracy_seismology_w64_e%d_m%d_t65536.txt"],
       ["IMU", "../../../transcampfpga/results/imu/accuracy_imu_w256_e%d_m%d_t65536.txt"],
       ["EPG", "../../../transcampfpga/results/epg/accuracy_epg_w16384_e%d_m%d_t65536.txt"]]
...
#  ax.plot_surface(X,Y,ZDff, cmap=plt.get_cmap('Reds'), linewidth=lw, alpha = 0.3,antialiased=True)
  ...
  if i == 0:
    ...
    #ax.text2D(-0.11, -0.05, 'TranSCAMPfpga', rotation=90 , fontsize=20)
