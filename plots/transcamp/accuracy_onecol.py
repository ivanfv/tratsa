...
files=[["Audio","../../../transcamp/results/result_audio-MPIII-SVD_w200_s1_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv"],
       ["ECG", "../../../transcamp/results/result_e0103_n180000_w500_s1_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv"],
       ["Power", "../../../transcamp/results/result_power-MPIII-SVF_n180000_w1325_s0.1_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv" ],
       ["Seismology", "../../../transcamp/results/result_seismology-MPIII-SVE_n180000_w50_s0.01_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv"],
       ["Human Activity", "../../../transcamp/results/result_human_activity-MPIII-SVC_w120_s1_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv"],
       ["Penguin Behavior", "../../../transcamp/results/result_penguin_sample_TutorialMPweb_w800_s1_d0_t256_cov%d-%d_corr%d-%d_stat%d-%d_prof%d-%d_*.csv"]]
...
#  ax.plot_surface(X,Y,ZDff, cmap=plt.get_cmap('Reds'), linewidth=lw, alpha = 0.3,antialiased=True)
  ...
  if i == 0:
    ...
    #ax.text2D(-0.11, -0.05, 'TranSCAMP', rotation=90 , fontsize=20)
...
plt.savefig("./accuracySCAMP.pdf", format='pdf')
