...
void ff_cast(flexfloat_t *obj, const flexfloat_t *source, flexfloat_desc_t desc, const uint32_t tid);
...
void ff_inverse(flexfloat_t *dest, const flexfloat_t *a, const uint32_t tid);
void ff_add(flexfloat_t *dest, const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
void ff_sub(flexfloat_t *dest, const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
void ff_mul(flexfloat_t *dest, const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
void ff_div(flexfloat_t *dest, const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
void ff_acc(flexfloat_t *dest, const flexfloat_t *a, const uint32_t tid);
void ff_fma(flexfloat_t *dest, const flexfloat_t *a, const flexfloat_t *b, const flexfloat_t *c, const uint32_t tid);


// Relational operators

bool ff_eq(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
bool ff_neq(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
bool ff_le(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
bool ff_lt(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
bool ff_ge(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
bool ff_gt(const flexfloat_t *a, const flexfloat_t *b, const uint32_t tid);
...
//RIC Cuando se usa FlexFloat con varios threads las estadísticas varían pq
//    no están protegidas y hay carreras de datos. Privatizo para cada thread
...
//RIC meto el max_thread_count
extern uint32_t thread_count;
extern HashSlot   op_stats[MAX_THREAD_COUNT][FLEXFLOAT_STATS_MAX_TYPES];
extern HashSlot cast_stats[MAX_THREAD_COUNT][FLEXFLOAT_STATS_MAX_TYPES*FLEXFLOAT_STATS_MAX_TYPES];
...
//RIC meto el número de threads en ff_start_stats, donde se instanciará thread_count global
void ff_start_stats(const uint32_t th_count);
void ff_stop_stats();
void ff_clear_stats();
void ff_print_stats();
